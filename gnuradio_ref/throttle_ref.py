...
class throttle_ref(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "throttle_ref")
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.digital_gmsk_demod_0, 0))
...
def main(top_block_cls=throttle_ref, options=None):
