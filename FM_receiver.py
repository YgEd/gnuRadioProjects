...
class FM_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._vol_range = qtgui.Range(0, 1, 0.05, 0, 200)
        ...
        self._freq_range = qtgui.Range(90e6, 110e6, 1e5, 100e6, 200)
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, sdr_samp_rate)
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(8, -1.0), 60.0))
        ...
        self.audio_sink_0 = audio.sink(int(24e3), '', True)
    ...
    def set_sdr_samp_rate(self, sdr_samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.sdr_samp_rate, 100e3, 30e3, window.WIN_KAISER, 6.76))
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.freq, self.sdr_samp_rate)
        self.soapy_bladerf_source_0.set_sample_rate(0, self.sdr_samp_rate)
