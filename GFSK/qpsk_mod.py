...
class fil_Transfer_skeleton(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.mod_obj = qpsk_obj
        self.modulation_order = 4
        self.rotational_sym_order = 4
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(
            (6.28/100), 
            self.rotational_sym_order, # amount of symbols = 2^(amount of bits per symbol)
            False)
        ...
        self.unpack = blocks.unpack_k_bits_bb(int(np.log2(self.modulation_order))) # number is how many bits per symbol
